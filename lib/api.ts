...
export const amebogistAPI = {
  articles: {
    ...
    /** POST /amebogist/articles/:id/react — type must be a valid ReactionType */
    react: (id: string, type: ReactionType) =>
      boldMindAPI.amebogist.react(id, type),
    ...
    generateAI: (payload: GenerateAIPayload) =>
      boldMindAPI.amebogist.generateAI(payload),
    ...
    getComments: (articleId: string, page?: number, limit?: number) =>
      boldMindAPI.amebogist.comments.list(articleId, page, limit),
  ...
  comments: {
    ...
    delete: (commentId: string) =>
      boldMindAPI.amebogist.comments.delete(commentId),

    /** PATCH /amebogist/comments/:id/react */
    react: (commentId: string, reaction: 'like' | 'dislike' | 'love') =>
      boldMindAPI.amebogist.comments.react(commentId, reaction),

    /** PATCH /amebogist/comments/:id/flag */
    flag: (commentId: string) =>
      boldMindAPI.amebogist.comments.flag(commentId),
  },
  ...
  rss: {
    ...
    categoryFeed: (category: Parameters<typeof boldMindAPI.amebogist.rss.categoryFeed>[0]) =>
